export const largeCardSections = [
    {
      id: 1,
      title: "מוצרי הקפה האהובים ביותר שלנו",
      snippet: "מוצרי הקפה האהובים והנמכרים ביותר בקרב לקוחותינו",
      cards: [
        {
          id: 19,
    ...
    },
    {
      id: 2,
      title: "!מבצעים חמים",
      snippet: "מבצעי החודש על מוצרים מבוקשים",
      cards: [
        {
          id: 22,
